...
ENV['RAILS_ENV'] ||= 'test'
require File.expand_path("../../../test/#{TestUtils.dummy_app_dir}/config/environment.rb",  __FILE__)
ENV['RAILS_ROOT'] ||= File.expand_path("../../../test/#{TestUtils.dummy_app_dir}",  __FILE__)
